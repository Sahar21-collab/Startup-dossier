...
6. Write in simple English for an adult whose first language is not English: short sentences of 12 to 18 words, everyday words ("use" not "utilise", "different" not "disparate"), and say who does what. Explain any industry term or abbreviation in brackets the first time. Never use marketing words such as revolutionary, game-changing, disruptive, innovative, cutting-edge, leading, seamless, all-in-one, ecosystem.
