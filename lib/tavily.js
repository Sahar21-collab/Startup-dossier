...
export async function searchWeb(startupName, founderName) {
  ...
  const founderQuery = founderName
    ? `${founderName} ${startupName} founder background education university career before founding`
    : `"${startupName}" founders co-founders background education university worked previously`;
